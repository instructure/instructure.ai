...
import type { AiInfoProps, AiInfoNutritionFactsProps, AiInfoDataPermissionLevelsProps, AiInfoAiInformationProps } from "./types";
const pluck = <TRecord extends Record<string, object>, K extends keyof TRecord[keyof TRecord]>(obj: TRecord, key: K): {
...
export { AiInfo, nutritionFacts, dataPermissionLevels, aiInformation, askyourdata, bcealttext, canvascoursetranslation, canvasdiscussionsummaries, canvasgradingassistance, canvasinboxtranslation, discussioninsights, igniteagent, portfolios, rubricgenerator, smartsearch };
