...
const InstructureWordMark: FC<SVGWrapperProps> = ({
	title = InstructureLogo.title,
	viewBox = "0 0 374.89 52.08",
	height = "100%",
	width = "300px",
}) => (
	<SVGWrapper height={height} title={title} viewBox={viewBox} width={width}>
		<rect
			height="12.73"
			rx="6.37"
			ry="6.37"
...
const InstructureBugClassic: FC<SVGWrapperProps> = ({
	title = InstructureLogo.title,
	height = "100%",
	width = "100%",
	viewBox = "0 0 252 252",
...
const InstructureBugNew: FC<SVGWrapperProps> = ({
	title = InstructureLogo.title,
	viewBox = InstructureLogo.viewBox,
	height = "100%",
	width = "100%",
	...
	<SVGWrapper height={height} title={title} viewBox={viewBox} width={width}>
		<rect fill={InstructureLogo.color} height="53.42" width="53.42" />
		<path
			d="M30.24,37.26h0c0-2.05,1.66-3.71,3.71-3.71s3.71,1.66,3.71,3.71-1.66,3.71-3.71,3.71-3.71-1.66-3.71-3.71"
			fill={CanvasLogo.color}
		/>
